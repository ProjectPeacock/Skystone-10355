 ...
 */
@Autonomous(name = "Red- Foundation, Skystones, Park", group = "EXPERIMENT")
//@Disabled
        ...
        while (opModeIsActive()) {
            switch (state) {
                ...
                case PLACE_FOUNDATION:
                    ...
                    /*
                     * Drive to the back wall (strafe right)
                     */
                    drive.translateTime(.3, 290, 1.5);

                    /*
                     *Drive forwards to grab the foundation
                     */
                     ...
                     */
                    drive.translateToWall(.3, 0, 20, 3);
//                    drive.translateTime(.3,0,2.5);
                    ...
                    /*
                     *Strafe to the left wall (strafe right)
                     */
                ...
                case LOCATE_SKYSTONE1:
                    ...
                    /*
                     *Rotates to face the foundation and drive forward
                     */
                    drive.rotateGyro(0.4, 90,"right",  1);

                    drive.translateTime(0.3, 180, .4);

                    /*
                     *Drop the skystone
                     */
                    robot.servoGrab.setPower(-0.4);
                ...
                case LOCATE_SKYSTONE2:
                     ...
                     * Uses the Rev 2m Range sensor on the back of the robot to measure distance.
                     */
                    drive.translateFromWall(0.1, 180, 65, 2);
     ...
     */
    enum State {
        PLACE_FOUNDATION, LOCATE_SKYSTONE1, LOCATE_SKYSTONE2, PARK_WALL, PARK_BRIDGE, HALT
    }
